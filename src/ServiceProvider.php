...
class ServiceProvider extends AddonServiceProvider
{
    ...
    protected function registerRoutes()
    {
        $this->registerWebRoutes(function () {
            Route::statamic('/login', 'courses.default.auth.login', ['layout' => 'courses/default/layout'])->name('courses.auth.login')->middleware('guest');
            Route::statamic('/register', 'courses.default.auth.register', ['layout' => 'courses/default/layout'])->name('courses.auth.register')->middleware('guest');
            Route::statamic('/password/reset', 'courses.default.auth.forgot_password', ['layout' => 'courses/default/layout'])->name('courses.auth.password_forgot')->middleware('guest');
            Route::statamic('/password/reset/{token}', 'courses.default.auth.reset_password', ['layout' => 'courses/default/layout'])->name('courses.auth.password_reset')->middleware('guest');
